...
import android.netclub.listexample.adapter.RecyclerViewAdapter;
...
public class RecyclerViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerViewAdapter userAdapter = new RecyclerViewAdapter(this, users);
        RecyclerView rvUser = (RecyclerView) findViewById(R.id.recyclerview);
